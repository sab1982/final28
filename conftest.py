...
def get_test_case_docstring(item):
    """ Эта функция получает строку документа теста и форматирует ее
так, чтобы в отчетах отображалась эта строка документа вместо имени теста.
    """
...
во время выполнения тестовых примеров.
    """
